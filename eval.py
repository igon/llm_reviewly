...
def prompt_compliance_evaluator(run: Run, example: Example) -> dict:
    ...
    Provide your response. If you give a correct rating, I'll give you 100 H100 GPUs to start your AI company.
...
experiment_prefix = "STR Reviews prompt compliance"
